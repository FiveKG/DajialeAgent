...
try {
    ...
    $match = array(//group是一对一的，不让改
        'localeId'=>'int','localeName'=>'string','perNumb'=>'int', 'userNumb'=>'int','ctrlCardLv'=>'int',
        'category'=>'int','maxNumb'=>'int','matchServerId'=>'int', 'gameType'=>'int','onoff'=>'int'
    );
    $casino = array(
        'id'=>'int',"condition"=>'int', "category"=>'int', "outRule"=>'int', "entranceFee"=>'int',
        "roomCost"=>'int', "carryMax"=>'int', "winMax"=>'int', "baseLine"=>'int'
    );
    $race = array(
        'id'=>'int',"raceTime"=>'string', "enrollTime"=>'string', "round"=>'int', "pernum"=>'string',
        "userNumb"=>'int', "score"=>'int', "condition"=>'string', "category"=>'int',
        "outRule"=>'string', "roomCost"=>'int', "baseLine"=>'int' , "tactics" => 'string'
    );
    $award = array(
        'id'=>'int',"minId"=>'int', "maxId"=>'int', "awards"=>'string'
    );
    $matchValidator = array(
        'group'=>'int', "sameIP"=>'int', "onlyAI"=>'string', "sameDesk"=>'string', "winRatio"=>'string', "winStreak"=>'string',
    ...
    ToolMySql::conn();
    $result = Game::updateMatches($requireData);
    if ($result !== true)
